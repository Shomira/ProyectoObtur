            ...
            <div class="container"style="margin: 0 auto">
                <div class="row justify-content-center">
                    <div class="container principal">
                        <div class="row">
                            <div class="col-lg-12 text-center" style="margin-left:2em;">
                                <div class="row">
                                    <div class="col-lg-20  col-md-12 mb-4">
                                        <div class="card-section border rounded p-3">
                                            <div class="card-header-first rounded pb-4">
                                                <h5 class="card-header-title text-white pt-3">Registro de Usuarios</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-header" > {{__('Lista de Usuarios')}}
                        <button  type="button" class="btn btn-warning text-white crearUs"  data-toggle="modal" data-target="#modalAgregar">
                            <img src="{{ asset('imgs/aus1.png')}}">Crear Usuario
                        </button>
                    </div>
                    <div class="card " style="width: 100%; margin: 0 auto">
                        <div class="card-body">
                            <table id="tabUsuario" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <td>Id</td>
                                        <td>Nombre</td>
